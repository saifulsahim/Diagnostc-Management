...
<div style="margin-left: 68%">
    <form id="searchForm" action="index.php"  method="get" style="margin-top: 5px; margin-bottom: 10px ">
        <input type="text" value="" id="searchID" name="search" placeholder="Search" width="50" >
        <input type="checkbox"  name="byName"   checked  >By Name
        <input type="checkbox"  name="byDesignation"  checked >By Designation
...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            <input class="btn btn-success" type="submit" value="Trash Multiple" >
            <input class="btn btn-danger" id="deleteMultiple" type="button" value="Delete Multiple" >
        </div>
    </div>
</div>
-->
    <h1>Active List- Doctors</h1>
