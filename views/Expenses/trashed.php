        ...
        foreach ($allData as $record) {
            ...
            <tr>
                ...
                <td>
                 ...
                 <a href='view.php?id=$record->id'</a><button class='btn btn-primary'>View</button>
                  <a href='edit.php?id=$record->id'</a><button class='btn btn-warning'>Edit</button>
                  <a href='recover.php?id=$record->id'</a><button class='btn btn-success'>Recover</button>
                  <a href='delete.php?id=$record->id'</a><button class='btn btn-danger' onclick='return confirm_delete()'>Delete</button>
