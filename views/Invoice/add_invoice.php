                ...
                <div id="invoice_section">
                    ...
                    if (!empty($_SESSION["test_cart"])) { ?>
                        ...
                        <table class="table table-bordered">
                            ...
                            foreach ($_SESSION["test_cart"] as $keys => $values) {
                                ?>

                                <tr>
                                    <td><?php echo $values["test_name"]; ?></td>
                                    <td><?php echo $values["test_price"]; ?></td>
                                    <td width="20%"><input readonly type="text" name="quantity"
                                                           value="<?php echo $values['quantity']; ?>"
                                                           id="test_quantity<?php echo $values['test_id']; ?>"
                                                           class="form-control quantity"
                                                           data-test-id="<?php echo $values['test_id']; ?>"></td>

                                    <td>
                                        $ <?php echo number_format($values["quantity"] * $values["test_price"], 2); ?></td>
                                    <td>
                                        <a href="add_invoice.php?action=delete&id=<?php echo $values["test_id"]; ?>"><span
                                                    class="text-danger">Remove</span></a></td>
                                </tr>
                                <?php
                                $total = $total + ($values["quantity"] * $values["test_price"]);
                            }
