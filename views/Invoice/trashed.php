...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            <h3 style="color: #442a8d;width:100%; font-size:">Trashed List- Invoice Information Entry</h3>
            ...
            <table class="table table-bordered table-striped">
                ...
                <a href='view.php?id=$record->id' class='btn btn-primary btn-sm'>View</a>
                 ...
                 <a href='recover.php?invoice_no=$record->invoice_no&id=$record->id' class='btn btn-warning btn-sm'>Recover</a>
